...
- 自动选择净应收最高的人作为主收款人；存在多位债权人时，会同时生成“欠款人 → 主收款人”和“主收款人 → 其他债权人”的完整路线。
...
最近一次完整自动化验收结果：`132` 项通过、`0` 项失败。覆盖金额解析、均摊与指定承担、两组确认算例、多债权人路线、本地持久化、成员编辑保护、损坏草稿降级、复制/返回/完成操作安全以及静态模板与触控尺寸检查。
